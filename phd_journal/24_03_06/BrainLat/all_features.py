...
def get_hjorth_features() -> DataFrame:
    # Hjorth Mobility
    cohort_files = glob('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/**/hjorth_mobility.pickle', recursive=True)
    mobility = {}
    ...
    # Hjorth Complexity
    cohort_files = glob('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/**/hjorth_complexity.pickle', recursive=True)
    complexity = {}
    for file in cohort_files:
        with open(file, 'rb') as f:
            x = load(f)
    ...
    # Hjorth Activity
    cohort_files = glob('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/**/hjorth_activity.pickle', recursive=True)
    activity = {}
    for file in cohort_files:
        with open(file, 'rb') as f:
            x = load(f)
    ...
    # Save to CSV
    res.to_csv('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/cohort_hjorth.csv')

    return res


def get_pli_features() -> DataFrame:
    all_files = glob('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/**/pli_*.pickle', recursive=True)
    cohort_features = {}
    ...
    # Save?
    cohort_features.to_csv('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/cohort_pli.csv')

    return cohort_features

def get_spectral_features() -> DataFrame:
    all_files = glob('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/**/spectral.csv', recursive=True)
    ...
    cohort_features.to_csv('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/cohort_spectral.csv')
    return cohort_features



def read_spectral_features() -> DataFrame:
    return pd.read_csv('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/cohort_spectral.csv', index_col=0)

def read_hjorth_features() -> DataFrame:
    return pd.read_csv('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/cohort_hjorth.csv', index_col=0)

def read_pli_features() -> DataFrame:
    return pd.read_csv('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/cohort_pli.csv', index_col=0)
...
def write_all_features() -> DataFrame:
    ...
    hjorth = read_hjorth_features()
    pli = read_pli_features()
    all_features = spectral.join(hjorth).join(pli)
    all_features.to_csv('/Volumes/MMIS-Saraiv/Datasets/BrainLat/features/cohort_allfeatures.csv')
