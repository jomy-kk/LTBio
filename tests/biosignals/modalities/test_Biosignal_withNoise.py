...
class BiosignalWithNoiseTestCase(unittest.TestCase):
    ...
    def test_noise_is_Noise_original_contiguous(self):
        ...
        self.assertTrue(allclose(self.samples2, noisy_ecg._get_channel('2').samples - self.noise.samples, rtol=0.1))
    ...
    def test_noise_is_Noise_original_discontiguous(self):
        ...
        self.assertTrue(allclose(self.samples1, noisy_ecg._get_channel('3').samples[0] - self.noise.samples[:6], rtol=0.1))
        self.assertTrue(allclose(self.samples3, noisy_ecg._get_channel('3').samples[1] - self.noise.samples[:12], rtol=0.1))
