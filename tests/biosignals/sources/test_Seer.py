...
from biosignals.modalities import ACC, EMG
from biosignals.sources import Seer
...
class SeerTestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.Seer = Seer.Seer()  # Seer needs to be instantiated only to test _read and _write methods, for they are protected.
