...
import pickle
pickle.dump(ss, open(main_dir + os.sep + patients + '_ecg_signal.pickle', 'wb'))
...
plt.title('Heart Rate Variability During Seizure')
ax2.set_ylabel('RR intervals (ms)')
ax2.set_xlabel('Time (s)')
ax1.set_ylabel('Beats per minute (bpm)')
ax1.set_xlabel('Time (s)')
ax1.set_title('Heart Rate During Focal Aware Seizure')
ax1.set_title('Heart Rate Variability During Focal Aware Seizure')
